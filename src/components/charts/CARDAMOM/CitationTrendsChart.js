    ...
    <div className="bg-white rounded-lg p-5 shadow-sm mb-6">
      ...
      <div className="flex flex-wrap gap-6 mt-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-600">Annual Papers</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-3 h-3 rounded bg-teal-600"></div>
          <span className="text-xs text-gray-600">
            Cumulative Papers ({chartData.totalPapers.toLocaleString()})
          </span>
        </div>
        <div className="flex items-center gap-2">
      ...
      <div className="mt-4 pt-4 border-t border-gray-100">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          ...
          <div>
            <div className="text-lg font-semibold text-gray-900">
              {chartData.totalPeerReviewed}
            </div>
            <div className="text-xs text-gray-500">Peer-Reviewed</div>
          </div>
          <div>
            <div className="text-lg font-semibold text-gray-900">
              {((chartData.totalPeerReviewed / chartData.totalPapers) * 100).toFixed(1)}%
            </div>
            <div className="text-xs text-gray-500">Peer-Reviewed Rate</div>
          </div>
          <div>
            <div className="text-lg font-semibold text-gray-900">
